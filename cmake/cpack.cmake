if( ENABLE_CPACK )
    ...
    set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "SummitGrid")
    set(CPACK_PACKAGE_VERSION ${${PROJECT_NAME}_VERSION})
    set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}_${${PROJECT_NAME}_VERSION}")
    ...
    if ( "${CPACK_GENERATOR}" STREQUAL "NSIS" )
        set( CPACK_NSIS_DISPLAY_NAME "${PROJECT_NAME} ${${PROJECT_NAME}_VERSION}")
